    ...
    return {
        ...
        execute: function() {
            AutoGrowDirective = (function () {
                function AutoGrowDirective(element, renderer) {
                    this.element = element;
                    this.renderer = renderer;
                }
                AutoGrowDirective.prototype.onFocus = function () {
                    this.renderer.setElementStyle(this.element.nativeElement, 'width', '200px');
                };
                AutoGrowDirective.prototype.onBlur = function () {
                    this.renderer.setElementStyle(this.element.nativeElement, 'width', '120px');
                };
